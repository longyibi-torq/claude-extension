...
- The two ecosystem diagrams use React 18 (loaded via CDN/UMD) with Babel standalone for JSX transform; the other pages are plain HTML

## Key Files

- `docs/index.html` — Landing page with side-by-side Claude Code vs ChatGPT/Codex columns
- `docs/claude-ecosystem-diagram.html` — Interactive React app: visual map of the Claude Code extension ecosystem
- `docs/claude-concepts.html` — Detailed reference for Claude Code extension concepts (plain HTML)
- `docs/chatgpt-ecosystem-diagram.html` — Interactive React app: visual map of the ChatGPT/Codex ecosystem
...
Validate changes manually — check links, responsive layout, and interactive diagram behavior. Confirm no JS console errors.
...
- Lowercase hyphenated filenames with platform prefix (e.g. `claude-concepts.html`, `chatgpt-ecosystem-diagram.html`)
